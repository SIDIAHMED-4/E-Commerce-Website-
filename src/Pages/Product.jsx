...
import RatingComp from "../Common/components/Rating";
...
import WishlistIcon from "../Common/components/WishlistIcon";
...
export const Product = () => {
  ...
  const renderStars = () => {
    return Array.from({ length: 5 }, (_, i) => {
      const filled = i < selectedProduct.stars;
            ...
            <div className="flex justify-center flex-col lg:flex-row  gap-16">
              ...
              <div className="flex gap-5 flex-col">
                <div className="flex gap-4 flex-col">
                  ...
                  <div className="flex  text-gray-500 text-sm gap-2 items-center ">
                    ...
                    <span>
                      ...
                      <span className="ml-4 text-green-300"> {i18n.t("productPage.inStock")}</span>
                    </span>
                  </div>
                 ...
                 {i18n.t("productPage.colors")}:
                  {["red", "blue"].map((color) => (
                    <button
                      ...
                      className=' w-4 m-1 h-4 rounded-full border-2 transition-transform hover:scale-110 '
                ...
                <div className="font-inter text-xl flex gap-4">
                  ...
                  {quantity === 0 ? (
                    <Button disabled>{i18n.t("redButtons.buyNow")}</Button>
                  ) : (
                    <Link to="/checkout">
                      <Button>{i18n.t("redButtons.buyNow")}</Button>
                    </Link>
                  )}
