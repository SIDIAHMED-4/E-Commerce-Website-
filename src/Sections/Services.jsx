...
const Service = ({ icon, description, value }) => {
  return (
    <Box className="flex gap-6 items-center justify-center flex-col bg-white px-4 py-8 text-center ">
      {icon}
...
const Services = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-8  ">
      <div className=" text-center md:text-start mx-8  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 md:gap-20 ">
        <Service
          icon={
            <svg
              width="81"
